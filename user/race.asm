...
user/_race:     file format elf64-littleriscv
...
int main() {
  ...
  10:	778000ef          	jal	788 <printf>

    int pid = fork(); // Create a second process
  14:	316000ef          	jal	32a <fork>

    if(pid == 0) {
  18:	e10d                	bnez	a0,3a <main+0x3a>
        // CHILD PROCESS: Run the Hog
        char *argv[] = {"hog", 0};
  1a:	00001797          	auipc	a5,0x1
  1e:	94678793          	addi	a5,a5,-1722 # 960 <malloc+0x120>
  22:	fef43023          	sd	a5,-32(s0)
  26:	fe043423          	sd	zero,-24(s0)
        exec("hog", argv);
  2a:	fe040593          	addi	a1,s0,-32
  2e:	853e                	mv	a0,a5
  30:	33a000ef          	jal	36a <exec>
    ...
    exit(0);
  34:	4501                	li	a0,0
  36:	2fc000ef          	jal	332 <exit>
        sleep(20); 
  3a:	4551                	li	a0,20
  3c:	396000ef          	jal	3d2 <sleep>
        int pid2 = fork();
  40:	2ea000ef          	jal	32a <fork>
        if(pid2 == 0) {
  44:	cd11                	beqz	a0,60 <main+0x60>
        wait(0); 
  46:	4501                	li	a0,0
  48:	2f2000ef          	jal	33a <wait>
        wait(0);
  4c:	4501                	li	a0,0
  4e:	2ec000ef          	jal	33a <wait>
        printf("--- RACE FINISHED ---\n");
  52:	00001517          	auipc	a0,0x1
  56:	91e50513          	addi	a0,a0,-1762 # 970 <malloc+0x130>
  5a:	72e000ef          	jal	788 <printf>
  5e:	bfd9                	j	34 <main+0x34>
            char *argv[] = {"task", 0};
  60:	00001797          	auipc	a5,0x1
  64:	90878793          	addi	a5,a5,-1784 # 968 <malloc+0x128>
  68:	fef43023          	sd	a5,-32(s0)
  6c:	fe043423          	sd	zero,-24(s0)
            exec("task", argv);
  70:	fe040593          	addi	a1,s0,-32
  74:	853e                	mv	a0,a5
  76:	2f4000ef          	jal	36a <exec>
  7a:	b7f1                	j	46 <main+0x46>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 64a:	34ab8b93          	addi	s7,s7,842 # 990 <digits>
 ...
 6a8:	2e448493          	addi	s1,s1,740 # 988 <malloc+0x148>
        for (; *s; s++)
