...
user/_testmlfq:     file format elf64-littleriscv
...
int main(int argc, char *argv[]) {
  ...
  16:	93e50513          	addi	a0,a0,-1730 # 950 <malloc+0x100>
  1a:	77e000ef          	jal	798 <printf>
  ...
  1e:	4481                	li	s1,0
        ...
        if (i % 10000000 == 0) {
  20:	ff5b0937          	lui	s2,0xff5b0
  24:	e5390913          	addi	s2,s2,-429 # ffffffffff5afe53 <base+0xffffffffff5aee43>
  28:	0932                	slli	s2,s2,0xc
  2a:	57990913          	addi	s2,s2,1401
  2e:	0932                	slli	s2,s2,0xc
  30:	5e990913          	addi	s2,s2,1513
  34:	093a                	slli	s2,s2,0xe
  36:	2bd90913          	addi	s2,s2,701
  3a:	00989a37          	lui	s4,0x989
  3e:	680a0a13          	addi	s4,s4,1664 # 989680 <base+0x988670>
            printf("Still working... (loop index: %ld)\n", i);
  42:	00001a97          	auipc	s5,0x1
  46:	92ea8a93          	addi	s5,s5,-1746 # 970 <malloc+0x120>
    for(long i = 0; i < 100000000; i++) {
  4a:	05f5e9b7          	lui	s3,0x5f5e
  4e:	10098993          	addi	s3,s3,256 # 5f5e100 <base+0x5f5d0f0>
  52:	a021                	j	5a <main+0x5a>
  54:	0485                	addi	s1,s1,1
  56:	03348263          	beq	s1,s3,7a <main+0x7a>
        if (i % 10000000 == 0) {
  5a:	032497b3          	mulh	a5,s1,s2
  5e:	97a6                	add	a5,a5,s1
  60:	87dd                	srai	a5,a5,0x17
  62:	43f4d713          	srai	a4,s1,0x3f
  66:	8f99                	sub	a5,a5,a4
  68:	034787b3          	mul	a5,a5,s4
  6c:	fef494e3          	bne	s1,a5,54 <main+0x54>
            printf("Still working... (loop index: %ld)\n", i);
  70:	85a6                	mv	a1,s1
  72:	8556                	mv	a0,s5
  74:	724000ef          	jal	798 <printf>
  ...
  7e:	91e50513          	addi	a0,a0,-1762 # 998 <malloc+0x148>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6b8:	2f448493          	addi	s1,s1,756 # 9a8 <malloc+0x158>
        for (; *s; s++)
